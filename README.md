...
- **`Core/`** — the vanilla load-bearing layer: **129 terminals** (103 construction-era + 11 purity-and-distance + 7 silence-theorem + 8 Plancherel-shadow) across 21 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (129/129). No terminal failed the bar; none is excluded.
