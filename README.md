...
- **`Core/`** — the vanilla load-bearing layer: **114 terminals** (the 103 construction-era
  terminals + the 11 purity-and-distance terminals) across 19 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (114/114). No terminal failed the bar; none is excluded.
