...
- **`Core/`** — the vanilla load-bearing layer: **138 terminals** (103 construction-era + 11 purity-and-distance + 7 silence-theorem + 8 Plancherel-shadow + 3 cross-place + 3 pairing + 3 twisted) across 24 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (138/138). No terminal failed the bar; none is excluded.
