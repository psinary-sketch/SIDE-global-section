...
- **`Core/`** — the vanilla load-bearing layer: **121 terminals** (103 construction-era + 11 purity-and-distance + 7 silence-theorem) across 20 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (121/121). No terminal failed the bar; none is excluded.
