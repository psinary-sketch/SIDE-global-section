...
- **`Core/`** — the vanilla load-bearing layer: **166 terminals** (103 construction-era + 11 purity-and-distance + 7 silence-theorem + 8 Plancherel-shadow + 3 cross-place + 3 pairing + 3 twisted + 3 deficit + 22 character-sum + 3 flatness) across 27 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (166/166). No terminal failed the bar; none is excluded.
