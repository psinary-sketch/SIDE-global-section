...
- **`Core/`** — the vanilla load-bearing layer: **132 terminals** (103 construction-era + 11 purity-and-distance + 7 silence-theorem + 8 Plancherel-shadow + 3 cross-place) across 22 modules plus their AxiomCheck
  ...
  assembly, `AXIOM_PRINTS.txt` (132/132). No terminal failed the bar; none is excluded.
